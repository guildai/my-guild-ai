...
|||
|-|-|
| <span data-guild-class="ls-dir-open">Guild Home Directory</span> | *default is `~/.guild`* |
| <span data-guild-class="ls-dir-open ls-1">cache</span> | *Guild-maintained caches* |
| <span data-guild-class="ls-dir ls-2">import-flags</span> | *cached flags imported from scripts* |
| <span data-guild-class="ls-dir ls-2">resources</span> | *cached resources* |
| <span data-guild-class="ls-dir ls-2">runs</span> | *indexed run scalars* |
| <span data-guild-class="ls-dir ls-1">locks</span> | *interprocess resource locks* |
| <span data-guild-class="ls-dir ls-1">remotes</span> | *remote state* |
| <span data-guild-class="ls-dir ls-1">runs</span> | *indexed run attributes and scalars* |
| <span data-guild-class="ls-dir-open ls-1">trash</span> | *deleted objects* |
| <span data-guild-class="ls-dir ls-2">runs</span> | *deleted runs* |
