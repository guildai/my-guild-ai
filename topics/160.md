...
Output patterns are [Python regular expressions](https://docs.python.org/library/re.html#regular-expression-syntax). Guild supports a variety of pattern formats for logging output scalars.

Refer to [*Guild File Reference*](/t/reference-guild-file/197#output-scalar-specs) for a complete specification of the `output-scalars` attribute.

Refer to [*Guild File Cheatsheet*](/t/cheatsheet-guild-file/192#output-scalars) for examples of `output-scalars`.
